        ...
        <div className="py-3 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            {!currentUser && (
              <>
                ...
                >
                  <Link
                    to="/signup"
                    className={`hidden md:block px-4 py-2 rounded-full  transition-all duration-300 font-semibold relative group focus:outline-none focus:ring-0 ${
                      isScrolled ? "bg-gray-800 text-gray-300" : "text-gray-600"
                    } `}
                  ...
                  >
                    ...
                    <motion.div
                      className={`absolute inset-0 rounded-full opacity-0 group-hover:opacity-100 ${
                        !isScrolled
                          ? "bg-blue-50 group-hover:border-blue-200 border"
                          : "bg-black"
                      } transition-all`}
                      transition={{ duration: 0.3 }}
                    />
            ...
            <div className="relative">
              ...
              >
                <FaBars
                  className={currentUser ? "text-blue-600" : "text-airbnb-dark"}
                />
                {currentUser ? (
                  <>
                    {loadingImage ? (
