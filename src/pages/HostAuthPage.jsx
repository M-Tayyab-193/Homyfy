    ...
    <div className="flex justify-center items-center min-h-[80vh] px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <FaAirbnb className="text-blue-500 text-5xl mx-auto mb-4" />
        ...
        <p className="text-center">
          {isLogin ? (
            <>
              New to hosting?{' '}
              <Link to="/host/signup" className="text-blue-500 hover:underline font-medium">
                Become a Host
              </Link>
            </>
          ) : (
            <>
              Already a host?{' '}
              <Link to="/host/login" className="text-blue-500 hover:underline font-medium">
                Log in
              </Link>
            </>
          )}
